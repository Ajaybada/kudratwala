...
const searchProducts = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json(new ApiResponse(200, products, "Suggestions fetched successfully"));
    } catch (error) {
        console.error(error);
        res.status(500).json(new ApiResponse(500, null, "Error fetching suggestions"));
    }
};


export {writeReview,getProducts,getProduct,addProduct,removeProduct ,searchProducts};